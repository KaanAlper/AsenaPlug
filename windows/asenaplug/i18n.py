...
TRANSLATIONS = {
    "en": {
        ...
        "op_fail": "Could not start the operation — try again.",
        ...
        "notify_full_no_blacklist": "Full mode routes everything — the blacklist has no effect here.",
        "notify_added_offline": "{domain} added — active automatically when you connect.",
        "autostart_boot": "Start on system boot",
        "notify_dpi_conflict": "{tool} is running — it conflicts with AsenaPlug (breaks the tunnel). Please close it.",
        "status_switching": "Status: Switching… ({detail})",
        "tip_switching": "{app}: Switching to {detail}…",
        "apply_btn": "Apply → {detail}",
        "status_ready": "Status: Ready · {detail}",
        "switching_btn": "Switching…",
        "connecting": "Connecting…",
        "disconnecting": "Disconnecting…",
        "status_connecting": "Status: Connecting… ({detail})",
    ...
    "de": {
        ...
        "op_fail": "Vorgang konnte nicht gestartet werden — erneut versuchen.",
        ...
        "notify_full_no_blacklist": "Voll-Modus leitet alles — die Blacklist hat hier keine Wirkung.",
        "notify_added_offline": "{domain} hinzugefügt — beim Verbinden automatisch aktiv.",
        "autostart_boot": "Beim Systemstart starten",
        "notify_dpi_conflict": "{tool} läuft — Konflikt mit AsenaPlug (Tunnel bricht). Bitte schließen.",
        "status_switching": "Status: Wird umgeschaltet… ({detail})",
        "tip_switching": "{app}: Wechsel zu {detail}…",
        "apply_btn": "Übernehmen → {detail}",
        "status_ready": "Status: Bereit · {detail}",
        "switching_btn": "Wird umgeschaltet…",
        "connecting": "Verbinden…",
        "disconnecting": "Trennen…",
        "status_connecting": "Status: Verbinden… ({detail})",
        "status_disconnecting": "Status: Trennen…",
    ...
    "es": {
        ...
        "op_fail": "No se pudo iniciar la operación — inténtalo de nuevo.",
        ...
        "notify_full_no_blacklist": "El modo completo enruta todo — la lista negra no tiene efecto aquí.",
        "notify_added_offline": "{domain} añadido — activo automáticamente al conectar.",
        "autostart_boot": "Iniciar al arrancar el sistema",
        "notify_dpi_conflict": "{tool} está en ejecución — entra en conflicto con AsenaPlug (rompe el túnel). Ciérralo.",
        "status_switching": "Estado: Cambiando… ({detail})",
        "tip_switching": "{app}: Cambiando a {detail}…",
        "apply_btn": "Aplicar → {detail}",
        "status_ready": "Estado: Listo · {detail}",
        "switching_btn": "Cambiando…",
        "connecting": "Conectando…",
        "disconnecting": "Desconectando…",
        "status_connecting": "Estado: Conectando… ({detail})",
        "status_disconnecting": "Estado: Desconectando…",
    ...
    "fr": {
        ...
        "op_fail": "Impossible de démarrer l'opération — réessayez.",
        ...
        "notify_full_no_blacklist": "Le mode complet route tout — la liste noire est sans effet ici.",
        "notify_added_offline": "{domain} ajouté — actif automatiquement à la connexion.",
        "autostart_boot": "Démarrer au démarrage du système",
        "notify_dpi_conflict": "{tool} est en cours — conflit avec AsenaPlug (brise le tunnel). Fermez-le.",
        "status_switching": "État : Changement… ({detail})",
        "tip_switching": "{app} : Passage à {detail}…",
        "apply_btn": "Appliquer → {detail}",
        "status_ready": "État : Prêt · {detail}",
        "switching_btn": "Changement…",
        "connecting": "Connexion…",
        "disconnecting": "Déconnexion…",
        "status_connecting": "État : Connexion… ({detail})",
        "status_disconnecting": "État : Déconnexion…",
    ...
    "tr": {
        ...
        "op_fail": "İşlem başlatılamadı — tekrar dene.",
        ...
        "notify_full_no_blacklist": "Full mod her şeyi tünelden geçirir — blacklist burada etkisiz.",
        "notify_added_offline": "{domain} eklendi — bağlanınca otomatik aktif olur.",
        "autostart_boot": "PC başlangıcında başlat",
        "notify_dpi_conflict": "{tool} açık — AsenaPlug ile çakışır (tüneli bozar). Lütfen kapatın.",
        "status_switching": "Durum: Değiştiriliyor… ({detail})",
        "tip_switching": "{app}: {detail} moduna geçiliyor…",
        "apply_btn": "Değiştir → {detail}",
        "status_ready": "Durum: Hazır · {detail}",
        "switching_btn": "Değiştiriliyor…",
        "connecting": "Bağlanıyor…",
        "disconnecting": "Kesiliyor…",
        "status_connecting": "Durum: Bağlanıyor… ({detail})",
        "status_disconnecting": "Durum: Kesiliyor…",
