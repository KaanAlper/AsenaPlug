...
TRANSLATIONS = {
    "en": {
        ...
        "notify_open_first": "Open {app} first.",
    ...
    "de": {
        ...
        "notify_open_first": "Öffne zuerst {app}.",
    ...
    "es": {
        ...
        "notify_open_first": "Abre {app} primero.",
    ...
    "fr": {
        ...
        "notify_open_first": "Ouvrez d'abord {app}.",
    ...
    "tr": {
        ...
        "notify_open_first": "Önce {app}'ı aç.",
